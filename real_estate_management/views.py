...
def about_me(request):
    context = {
        ...
        'name':'David Lupiañez',
        'age':39,
        'excerpt':'I have a Bachelor degree in information systems, with extensive experience in various areas of software development. I am strongly achievement-oriented with outstanding teamwork skills. I have developed in numerous technologies and languages, currently I am specializing in Python and Django Framework.',
